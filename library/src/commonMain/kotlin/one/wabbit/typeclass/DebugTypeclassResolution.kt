 ...
 *
 * This annotation is source-retained because it only controls compiler
 * diagnostics and tracing behavior; it is not part of the runtime semantics of
...
/**
 * Available trace modes for [DebugTypeclassResolution] and the matching
 * compiler-plugin option.
 */
public enum class TypeclassTraceMode {
    /**
     * Inherit the enclosing scope's trace mode, or the global compiler default
     * when there is no enclosing annotated scope.
     */
    INHERIT,
    ...
    /**
     * Emit trace output for failed resolutions and explain rejected
     * alternatives.
     */
