 ...
 *
 * Unlike [Equiv], [Iso] is not a typeclass and is intended for direct user-authored values. It
 * models a specific conversion object rather than compiler-owned canonical equivalence evidence.
 */
