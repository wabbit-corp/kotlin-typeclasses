...
// managed-integrity-v1: TYDggJECbkj
//
...
mavenPublishing {
    ...
    pom {
        ...
        description.set("K2 compiler plugin that resolves typeclass evidence, validates instances and derivations, and rewrites contextual calls for kotlin-typeclasses.")
...
dependencies {
    implementation(project(":kotlin-typeclasses")) // 0.1.0
