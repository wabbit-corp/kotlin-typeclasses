...
class DeriveViaTransportTypeIdentityTest {
    @Test
    fun distinctSameNamedTypeParametersAreNotTheSameTransportType() {
        val packageFragment = testPackageFragment()
        val leftOwner = irClass("LeftOwner", packageFragment, listOf("T"))
    ...
    @Test
    fun recreatedTypesWithTheSameClassifierShapeStillMatchStructurally() {
        val packageFragment = testPackageFragment()
        val box = irClass("Box", packageFragment, listOf("T"))
        val leaf = irClass("Leaf", packageFragment)

        val first = simpleType(box, listOf(simpleType(leaf)))
        val second = simpleType(box, listOf(simpleType(leaf)))
