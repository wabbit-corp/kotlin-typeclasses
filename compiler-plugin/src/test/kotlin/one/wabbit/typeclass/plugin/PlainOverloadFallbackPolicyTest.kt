    ...
    fun exactPlainFallbackShapeMatchingUsesTheActiveBuiltinConfiguration() {
        ...
        assertTrue(
            exactPlainOverloadFallbackShapesMatch(
                ...
                callee = contextual,
                configuration =
                    TypeclassConfiguration(builtinKClassTypeclass = TypeclassBuiltinMode.ENABLED),
            )
        )
        assertFalse(
            exactPlainOverloadFallbackShapesMatch(
...
private fun buildContextParameter(function: IrSimpleFunction, name: String, type: IrType) =
