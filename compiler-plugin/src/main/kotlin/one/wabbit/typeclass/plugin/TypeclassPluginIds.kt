...
internal const val DEBUG_TYPECLASS_RESOLUTION_ANNOTATION_FQ_NAME: String =
    "one.wabbit.typeclass.DebugTypeclassResolution"
internal const val TYPECLASS_TRACE_MODE_FQ_NAME: String = "one.wabbit.typeclass.TypeclassTraceMode"
internal const val GADT_DERIVATION_POLICY_ANNOTATION_FQ_NAME: String =
    "one.wabbit.typeclass.GadtDerivationPolicy"
internal const val GADT_DERIVATION_MODE_FQ_NAME: String = "one.wabbit.typeclass.GadtDerivationMode"
internal const val GENERATED_WRAPPER_ANNOTATION_FQ_NAME: String =
    "one.wabbit.typeclass.GeneratedTypeclassWrapper"
internal const val GENERATED_INSTANCE_ANNOTATION_FQ_NAME: String =
    "one.wabbit.typeclass.GeneratedTypeclassInstance"
internal const val PRODUCT_TYPECLASS_DERIVER_FQ_NAME: String =
    "one.wabbit.typeclass.ProductTypeclassDeriver"
...
internal const val PRODUCT_FIELD_METADATA_FQ_NAME: String =
    "one.wabbit.typeclass.ProductFieldMetadata"
internal const val PRODUCT_TYPECLASS_METADATA_FQ_NAME: String =
    "one.wabbit.typeclass.ProductTypeclassMetadata"
internal const val SUM_CASE_METADATA_FQ_NAME: String = "one.wabbit.typeclass.SumCaseMetadata"
internal const val SUM_TYPECLASS_METADATA_FQ_NAME: String =
    "one.wabbit.typeclass.SumTypeclassMetadata"
internal const val ENUM_ENTRY_METADATA_FQ_NAME: String = "one.wabbit.typeclass.EnumEntryMetadata"
internal const val ENUM_TYPECLASS_METADATA_FQ_NAME: String =
    "one.wabbit.typeclass.EnumTypeclassMetadata"
internal const val RECURSIVE_TYPECLASS_INSTANCE_CELL_FQ_NAME: String =
    "one.wabbit.typeclass.RecursiveTypeclassInstanceCell"
...
internal const val STRICT_SUBTYPE_PROOF_FQ_NAME: String =
    "one.wabbit.typeclass.UnsafeAssertStrictSubtype"
...
internal const val NOT_NULLABLE_PROOF_FQ_NAME: String =
    "one.wabbit.typeclass.UnsafeAssertNotNullable"
internal const val IS_TYPECLASS_INSTANCE_FQ_NAME: String =
    "one.wabbit.typeclass.IsTypeclassInstance"
...
internal const val SAME_TYPE_CONSTRUCTOR_PROOF_FQ_NAME: String =
    "one.wabbit.typeclass.UnsafeAssertSameTypeConstructor"
...
internal val TYPECLASS_ANNOTATION_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(TYPECLASS_ANNOTATION_FQ_NAME))
internal val INSTANCE_ANNOTATION_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(INSTANCE_ANNOTATION_FQ_NAME))
internal val DERIVE_ANNOTATION_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(DERIVE_ANNOTATION_FQ_NAME))
internal val DERIVE_VIA_ANNOTATION_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(DERIVE_VIA_ANNOTATION_FQ_NAME))
internal val DERIVE_EQUIV_ANNOTATION_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(DERIVE_EQUIV_ANNOTATION_FQ_NAME))
...
internal val TYPECLASS_TRACE_MODE_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(TYPECLASS_TRACE_MODE_FQ_NAME))
...
internal val GADT_DERIVATION_MODE_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(GADT_DERIVATION_MODE_FQ_NAME))
internal val GENERATED_WRAPPER_ANNOTATION_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(GENERATED_WRAPPER_ANNOTATION_FQ_NAME))
internal val GENERATED_INSTANCE_ANNOTATION_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(GENERATED_INSTANCE_ANNOTATION_FQ_NAME))
...
internal val PRODUCT_TYPECLASS_DERIVER_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(PRODUCT_TYPECLASS_DERIVER_FQ_NAME))
internal val TYPECLASS_DERIVER_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(TYPECLASS_DERIVER_FQ_NAME))
...
internal val PRODUCT_FIELD_METADATA_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(PRODUCT_FIELD_METADATA_FQ_NAME))
internal val PRODUCT_TYPECLASS_METADATA_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(PRODUCT_TYPECLASS_METADATA_FQ_NAME))
internal val SUM_CASE_METADATA_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(SUM_CASE_METADATA_FQ_NAME))
internal val SUM_TYPECLASS_METADATA_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(SUM_TYPECLASS_METADATA_FQ_NAME))
internal val ENUM_ENTRY_METADATA_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(ENUM_ENTRY_METADATA_FQ_NAME))
internal val ENUM_TYPECLASS_METADATA_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(ENUM_TYPECLASS_METADATA_FQ_NAME))
...
internal val STRICT_SUBTYPE_PROOF_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(STRICT_SUBTYPE_PROOF_FQ_NAME))
...
internal val NOT_NULLABLE_PROOF_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(NOT_NULLABLE_PROOF_FQ_NAME))
internal val IS_TYPECLASS_INSTANCE_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(IS_TYPECLASS_INSTANCE_FQ_NAME))
...
internal val SAME_TYPE_CONSTRUCTOR_PROOF_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(SAME_TYPE_CONSTRUCTOR_PROOF_FQ_NAME))
...
internal val SERIALIZABLE_ANNOTATION_CLASS_ID: ClassId =
    ClassId.topLevel(FqName(SERIALIZABLE_ANNOTATION_FQ_NAME))
